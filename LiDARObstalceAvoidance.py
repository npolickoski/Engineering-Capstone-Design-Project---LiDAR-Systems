...
def initLiDARSystem(commsLiDAR):
    """
    ...
    # Update Rate
    Update1 = 12                                            # update rate between 1-12
    Update = int(Update1)
